    ...
    <>
      ...
      <main className="container my-8">
        <section className="mt-12 flex flex-col items-center mb-8 text-m-black">
          <p className="uppercase  font-bold" style={{ fontSize: 28 }}>
        ...
        <main className="px-4 my-8  pt-10 font-open-sans">
          <section class="condition ">
            <h1 className="font-Roboto-Semibold text-xlFontSize text-center pb-6">Terms of Service</h1>
            <p className="font-Roboto-Regular text-regularFontSize">By using it, you are agreeing to these Terms & Conditions (defined below). Please read them carefully. Mobilicis India Private Limited., doing business as “ORUphones”.</p>
            <p className="font-Roboto-Regular text-regularFontSize">“ORUphones” owns and operates the website, www.oruphones .com. In the event of the user failing to comply with these Terms and Conditions, ORUphones has full authority to restrict or terminate your website usage rights or even access to the platform instantly. We can also remove all non-compliant information or remove both the user and their content from our platform with the help of Information Technology Rules (Intermediary Guidelines and Digital Media Ethics Code), 2021. As you use the ORUphones Platform and access our online services, you show that you understand and agree to the rules under the Terms and Conditions.</p>
            <p className="font-Roboto-Regular text-regularFontSize">If you are not in agreement with these Terms and Conditions, you may refrain from using our platform and services.</p>
            <p className="font-Roboto-Medium pt-2 text-regularFontSize">Our Terms and Conditions pertain to-</p>
