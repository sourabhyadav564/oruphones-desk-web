...
return(
    <>
          ...
          <p className=" text-4xl text-fx font-Roboto-Medium px-20" > Get grade of your phone</p>
          ...
          <div className=" text-px justify-left pt-8 px-20 " >
                  ...
                  gradePhone(reportID, Cookies.get("sessionId")).then((res) => {
                    if (res?.dataObject?.reportLink !== "No report found") {
                      ...
                      console.log(res);
                        ...
                        console.log(res);
                      toast.warning("Report not found", { toastId: "020",
                      position: toast.POSITION.TOP_CENTER,
                    });
              ...
              <button className=" border-2 border-primary text-tx text-primary-light
               py-2 pb-8  font-Roboto-Semibold rounded-lg w-52 text-white bg-m-green 
              "
               onClick={handleClick}  >
                Download My Reports </button>
