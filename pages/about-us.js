    ...
    <>
      ...
      <main className="container my-8">
        <section className="bg-m-green h-52 py-8 px-12 flex items-center shadow rounded-md mb-4">
          <h1 className="text-6xl font-Roboto-Bold text-m-grey-5"> About Us </h1>
        </section>
        {/* {parse(htmlText1)} */}
        <div className="content mt-8">
          ...
          <div>
            <div className="font-Roboto-Semibold text-xl2FontSize"> 02. Safe & Secure</div>
            <div className="font-Roboto-Light text-xlFontSize">Fake or counterfeit smartphones are common in the used & second-hand phone markets in India. Online markets have a higher risk as you cannot personally check out the condition of the device. Phones that look brand new in pictures might be functioning with an outdated processor; or with cheaper components in place of the original parts. It takes extreme precautions and precise observation to spot these fake devices from real ones.
          ...
          <div>
            <div className="font-Roboto-Semibold text-xl2FontSize"> 03. Convenient</div>
            <div className="font-Roboto-Light text-xlFontSize">ORUphones is a website that makes selling and buying old phones easier. With the provision of the
          ...
          <div className="my-2">
            <div className="font-Roboto-Medium text-xlFontSize">That apart, our proprietary algorithm curates <br />
              ...
              <span className="underline">Best Deal for Sellers: </span> Get the maximum cash for your old Phone with our "Recommended price" algorithm</div>
          </div>
        </div>
      </main>
    </>
