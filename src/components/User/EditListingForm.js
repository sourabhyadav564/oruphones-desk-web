...
function EditListingForm({ id, openPopup, openTCPopup, brandsList }) {
	...
	const [conditionQuesEdit, setConditionQuesEdit] = useState(
		listedDeviceInfo?.cosmetic
	);
	...
	}, [conditionEdit, conditionResults, open, conditionQuesEdit]);
	...
	return (
		<div className="p-8">
				...
				<div className="grid grid-cols-2 gap-8 ">
					...
					<>
						...
						>
							{deviceCondition
								? deviceCondition
								: listedDeviceInfo?.deviceCondition}
							<div
								className="absolute top-[390px] text-lg bg-white py-1 z-1 duration-300 origin-0 text-[13px]"
				...
				{listedDeviceInfo?.charger &&
					...
					listedDeviceInfo?.originalbox && (
						<div className="grid grid-cols-4 gap-4 mb-8">
							...
							<Checkbox
								src={
									'https://d1tl44nezj10jx.cloudfront.net/web/assets/svgicons/earphones.svg'
								}
								text="Earphones"
								onClick={(e) => {
							...
							<Checkbox
								...
								onClick={(e) => {
									...
									setWarranty(
										listedDeviceInfo?.warranty != 'None' ||
											listedDeviceInfo?.warranty != '' ||
											listedDeviceInfo?.warranty != null
											? listedDeviceInfo?.warranty
											: 'more'
									);
								}}
			...
			<DeviceConditionPopup
				open={open}
				setOpen={setOpen}
				setConditionEdit={setConditionEdit}
				setConditionQuesEdit={setConditionQuesEdit}
			/>
		</div>
	);
}
