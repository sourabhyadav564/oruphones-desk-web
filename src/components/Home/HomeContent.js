		...
		<section className="container mb-6 mt-8">
			<div className="content">
				<div id="why_ORUphones" className="text-justify">
					<div className="text-2xl text-center  font-Roboto-Bold">
						Why should I use ORUphones?
					</div>
					<br />
					<h1 className="font-Roboto-Light text-xl FontSize">
						Buy & Sell Your Phone at ORUphones{' '}
					</h1>
					...
					<div className="font-Roboto-Medium text-xlFontSize">
						{' '}
						Why should you sell your old mobile on ORUphones?{' '}
					</div>
					<div className="font-Roboto-Light text-mediumFontSize  text-justify">
				...
				<div id="how_to_sell">
					<div className="font-Roboto-Medium text-xlFontSize">
						How to Sell Used Phone with ORUphones?
					</div>
					<div className="font-Roboto-Light text-mediumFontSize  text-justify">
						You can sell used phones online through ORUphones in 3 easy steps.
					</div>
					<div className="font-Roboto-Regular text-mediumFontSize ">
				...
				<div id="how_to_buy">
					<div className="font-Roboto-Medium text-xlFontSize">
						How to Buy ORUphones Verified Used Phones?
					</div>
					<div className="font-Roboto-Light text-mediumFontSize  text-justify">
				...
				<div>
					<br />
					<div className="font-Roboto-Medium text-xlFontSize">
						Popular Brands Listed on ORUphones
					</div>
					<div className="font-Roboto-Light text-mediumFontSize  text-justify">
