	...
	return (
		<section className="bg-m-green text-white pt-16 ">
			<div className="container flex items-center md:justify-around flex-col md:flex-row ">
				<p className="font-Roboto-Semibold text-xl3FontSize text-center uppercase">
					Sign up for newsletter
				</p>
				<form
					className="flex max-w-md flex-1 mt-8  md:mt-0"
				...
				>
					...
					<button
						type="submit"
						className="btn bg-m-black hover:bg-green-600 hover:text-m-white rounded-none rounded-r-md font-Roboto-Semibold text-xlFontSize"
					>
						Subscribe
					</button>
				</form>
