...
function Services() {
	...
	return (
		<>
			<Head>
				<title>Buy and Sell Used Phones - Quality Services | Oruphones</title>
				<meta
					name="description"
					content={
						'Now buy and sell used phones Online in India. Trust Oruphones for a seamless experience and top-quality devices.'
					}
				/>
			</Head>
