			...
			<div>
				<h2>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>Privacy Policy - Current [updated on August 01, 2022]</span
					>
				</h2>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						services, content, features, technologies, or functions, and all
						related websites, mobile apps, mobile sites or other online
						platforms or applications offered to you by us (collectively the
						&quot;Services/Platform&quot;).</span
					>
				</p>
				<h3>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						registered in India, is the data controller for the personal data
						collected through this Platform. (&ldquo;we&rdquo;,
						&ldquo;our&rdquo; or &ldquo;us&rdquo;) take the security of your
						personal data very seriously and are committed to protecting and
						respecting the privacy of the users (&ldquo;you&rdquo; or
						&ldquo;your&rdquo;) of our ORUphones Website and App (the
						&ldquo;Platform&rdquo;).</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Interpretation and Definitions</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						defined under the following conditions.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>The following definitions shall have the same meaning regardless of
						whether they appear in singular or in plural.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<ol>
					...
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
							...
							&quot;I&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
							in this Agreement) refers to MOBILICIS INDIA PRIVATE LIMITED that
							owns website ORUphones.com&nbsp;</span
						>
					</li>
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
					...
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
							...
							https://www.oruphones.com</span
						>
					</li>
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>Service refers to the Website.</span
						>
					</li>
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>Country refers to: India</span
						>
					</li>
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Collecting and Using Your Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Tracking Technologies and Cookies</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						track information and to improve and analyze Our Service.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						You may not be able to use some parts of our Service.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						the &quot;What Are Cookies&quot; article.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>1. Necessary / Essential Cookies</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						provide You with those services.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong
							>2. Cookies Policy / Notice Acceptance Cookies</strong
						></span
					>
				</p>
				<p>
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>3. Functionality Cookies</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						your preferences every time You use the Website.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>For more information about the cookies we use and your choices
						regarding cookies, please visit our Cookies Policy.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Use of Your Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<ol>
					...
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
							...
							visited our Service, to contact You.</span
						>
					</li>
					<li>
						<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Retention of Your Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Transfer of Your Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Disclosure of Your Personal Data</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Business Transactions</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Law enforcement</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Other legal requirements</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<ul>
					<p>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>1. Comply with a legal obligation</span
						>
					</p>
					<p>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>2. Protect and defend the rights or property of the Company</span
						>
					</p>
					<p>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>3. Prevent or investigate possible wrongdoing in connection with
							the Service</span
						>
					</p>
					<p>
					...
					<p>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>5. Protect against legal liability</span
						>
					</p>
					<p>
						<span style="font-family: Arial, Helvetica, sans-serif"
							>6. Security of Your Personal Data</span
						>
					</p>
				</ul>
				<p>
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						...
						it for any other purpose.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Behavioral Remarketing</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>You can opt out of targeted advertising by:</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>INCLUDE OPT-OUT LINKS FROM WHICHEVER SERVICES BEING USED.</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>COMMON LINKS INCLUDE:</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<!-- <p><span style="font-family: Arial, Helvetica, sans-serif;">GOOGLE&nbsp;-
                    https://www.google.com/settings/ads/anonymous</span></p> -->
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>BING&nbsp;-
						https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</span
					>
				</p>
				<!-- <p><span style="font-family: Arial, Helvetica, sans-serif;">PINTEREST&nbsp;-
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Children&apos;s Privacy</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Links to Other Websites</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>Changes to this Privacy Policy</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
				...
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>By email:&nbsp;contact@oruphones.com</span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						><strong>MOBILICIS INDIA PRIVATE LIMITED</strong></span
					>
				</p>
				<p>
					<span style="font-family: Arial, Helvetica, sans-serif"
						>Privacy Policy of https://www.oruphones.com</span
					>
				</p>
			</div>
		</section>
