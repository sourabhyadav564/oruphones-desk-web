...
function Filter2({ listingsCount, children, setApplySort, setApplyFilter, makeName, makename }) {
    ...
    else if (filterOptions && (router.query.categoryType == "brandWarranty" || router.query.categoryType == "sellerWarranty" || router.query.categoryType == "warranty")) {
        tempFilters = filterOptions.map((i) =>
            i.id === "warranty" && router.query.categoryType.toString() == "brandWarranty"
                ...
                } : i.id === "warranty" && router.query.categoryType.toString() == "warranty" ? {
                    ...i,
                    options: [
                        {
                            value: "All",
