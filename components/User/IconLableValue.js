      ...
      <div className="flex items-center flex-wrap">
        <div className="flex-1 flex items-center flex-nowrap">
          {label.toUpperCase().includes("CONDITION") ? (
            <Image src={"https://d1tl44nezj10jx.cloudfront.net/assets/svgicons/quality.svg"} width={13} height={13} layout="fixed" alt={label} />
          ) : label.toUpperCase().includes("COLOR") ? (
            <Image src={"https://d1tl44nezj10jx.cloudfront.net/assets/svgicons/color.svg"} width={13} height={13} layout="fixed" alt={label} />
          ) : label.toUpperCase().includes("STORAGE") ? (
            <Image src={"https://d1tl44nezj10jx.cloudfront.net/assets/svgicons/micro-sd.svg"} width={13} height={13} layout="fixed" alt={label} />
          ) : label.toUpperCase().includes("ACCESSORIES") ? (
            <Image src={"https://d1tl44nezj10jx.cloudfront.net/assets/svgicons/charger2.svg"} width={13} height={13} layout="fixed" alt={label} />
            ...
            <Image src={"https://d1tl44nezj10jx.cloudfront.net/assets/icons/location.svg"} width={13} height={13} layout="fixed" alt={label} />
          ) : (
            ""
          )}
