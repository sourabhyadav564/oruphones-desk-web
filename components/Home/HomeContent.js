    ...
    <section className="container mb-6 mt-8">
      <div className="content">
        ...
        <div id="how_to_sell">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 1: Add your Device </div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 2: Device Verification</div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 3: Get Cash</div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
        ...
        <div id="how_to_buy">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 1: Select Device</div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 2: Contact Seller</div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize text-left">Step 3: Verify your Purchase</div>
          <div className="font-Roboto-Light text-mediumFontSize text-left">
