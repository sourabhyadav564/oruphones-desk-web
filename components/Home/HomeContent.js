  ...
  return (
    <section className="container mb-6 mt-8">
      <div className="content">
        <div id="why_ORUphones" className="text-justify">
          ...
          <div className="font-Roboto-Light text-mediumFontSize text-justify">
          ...
          <div className="font-Roboto-Medium text-xlFontSize"> Why should you sell your old mobile on ORUphones? </div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
        ...
        <div id="how_to_sell">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 1: Add your Device </div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 2: Device Verification</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 3: Get Cash</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
        ...
        <div id="how_to_buy">
          <div className="font-Roboto-Medium text-xlFontSize">How to Buy ORUphones Verified Used Phones?</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 1: Select Device</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 2: Contact Seller</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
          ...
          <div className="font-Roboto-Regular text-mediumFontSize ">Step 3: Verify your Purchase</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
        ...
        <div><br />
          <div className="font-Roboto-Medium text-xlFontSize">Popular Brands Listed on ORUphones</div>
          <div className="font-Roboto-Light text-mediumFontSize  text-justify">
